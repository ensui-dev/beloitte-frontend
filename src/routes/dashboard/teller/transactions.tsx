/**
 * Teller Transaction Log - same as accountant transaction history.
 * Re-exports the accountant version since tellers need the same
 * bank-wide read-only view of transactions.
 */
                  ...
                  return (
                    <TableRow key={tx.id} className="border-white/[0.06]">
                      ...
                      <TableCell className="text-xs text-muted-foreground">
                        ...
                        <br />
                        <span className="font-mono">{tx.account.iban.slice(-8)}</span>
                      </TableCell>
                      <TableCell>
