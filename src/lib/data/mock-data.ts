...
export const transactions: readonly Transaction[] = [
  ...
  },
  {
    ...
    counterparty: "DC Hardware Co",
    reference: "SWF-2026-00110",
    status: "completed",
  ...
  },
  {
    ...
    amount: 150,
    currency: siteConfig.currency.code,
    description: "Donation, DC Community Fund",
    counterparty: "DC Treasury",
    reference: "SWF-2026-00068",
    status: "completed",
  ...
  },
  {
    ...
    counterparty: "DC Land Registry",
    reference: "SWF-2026-00041",
    status: "failed",
